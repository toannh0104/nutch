...
public class NutchConfiguration {
  ...
  /*created by bachtv*/
  public static Configuration createUsingCustomConfig(Map<String,String> mapValueProperty) {
    Configuration conf = new Configuration();
    setUUID(conf);
    addNutchResourcesUsingCustomConfig(conf, mapValueProperty);	    	        
    return conf;
  }
  
  /*created by bachtv*/
  private static Configuration addNutchResourcesUsingCustomConfig(Configuration conf, Map<String,String> mapValueProperty) {	    
    conf.addResource("nutch-default.xml");
    conf.addResource("nutch-site.xml");
    for (String propertyName: mapValueProperty.keySet()) {
    	conf.set(propertyName, mapValueProperty.get(propertyName));
    }	    
    return conf;
  }
