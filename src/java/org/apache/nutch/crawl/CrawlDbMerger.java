...
//        LOG.info("bachtv==============mergedb: key " + key + " status: " + val.getStatus());
      ...
      if (res.getStatus() != CrawlDatum.STATUS_DB_UNFETCHED)
  ...
  public static int run(Map<String,String> mapValueProperty, String[] args) throws Exception {
	    return ToolRunner.run(NutchConfiguration.create(), new CrawlDbMerger(), args);	    
  }
