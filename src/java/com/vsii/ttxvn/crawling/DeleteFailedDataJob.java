 ...
 ***/
public class DeleteFailedDataJob extends Configured implements Tool {

    public static final Logger LOG = LoggerFactory
            .getLogger(DeleteFailedDataJob.class);
    ...
    public static class DedupReducer implements
        ...
        private void writeOutAsDuplicate(CrawlDatum datum,
            ...
            reporter.incrCounter("DeleteFailedDataJobStatus",
    ...
    public int run(String[] args) throws IOException {
        ...
        try {
            ...
            LOG.error("DeleteFailedDataMergeJob: "
        ...
        LOG.info("DeleteFailedData finished at " + sdf.format(end)
    ...
    public static void main(String[] args) throws Exception {
        int result = ToolRunner.run(NutchConfiguration.create(),
                new DeleteFailedDataJob(), args);
        System.exit(result);
    }
    
    public static int run(Map<String,String> mapValueProperty, String[] args) throws Exception {
        return ToolRunner.run(NutchConfiguration.createUsingCustomConfig( mapValueProperty), new DeleteFailedDataJob(), args);
    }
}
